...
namespace CryptoApisLibrary.Tests
{
    internal static class Features
    {
        ...
        {
            public static int BtcMainNet { get; } = 546903;
            public static int BtcTestNet { get; } = 1;
            public static int BchMainNet { get; } = 5;
            public static int BchTestnet { get; } = 1;
            public static int LtcMainNet { get; } = 1354896;
            public static int LtcTestnet { get; } = 1;
            public static int DogeMainNet { get; } = 5;
            public static int DogeTestnet { get; } = 1;
            public static int DashMainNet { get; } = 5;
            public static int DashTestnet { get; } = 1;
