...
{
    [TestClass]
    public class HistoricalOhlcvWithEndPeriodByExchange : BaseCollectionTest
    {
        [TestMethod]
        ...
        public void StartTimeMoreThanEndTime_Exception()
        {
            ...
            Manager.Exchanges.Ohlcv.Historical(exchange, period, startPeriod, endPeriod);
        }
        ...
        public void IncorrectEndTimeFromFeature_EmptyResultCollection()
        {
            ...
            var response = Manager.Exchanges.Ohlcv.Historical(exchange, period, startPeriod, endPeriod);
        ...
        {
            return Manager.Exchanges.Ohlcv.Historical(Exchange, Period, StartPeriod, EndPeriod);
        }

        protected override ICollectionResponse GetSkipList(int skip)
        {
            return Manager.Exchanges.Ohlcv.Historical(Exchange, Period, StartPeriod, EndPeriod, skip: skip);
        }

        protected override ICollectionResponse GetLimitList(int limit)
        {
            return Manager.Exchanges.Ohlcv.Historical(Exchange, Period, StartPeriod, EndPeriod, limit: limit);
        }

        protected override ICollectionResponse GetSkipAndLimitList(int skip, int limit)
        {
            return Manager.Exchanges.Ohlcv.Historical(Exchange, Period, StartPeriod, EndPeriod, skip, limit);
        }
