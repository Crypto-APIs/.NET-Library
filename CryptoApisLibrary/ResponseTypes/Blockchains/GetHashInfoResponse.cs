...
namespace CryptoApisLibrary.ResponseTypes.Blockchains
{
    ...
    public abstract class BaseGetHashInfoPayload
    {
    ...
    public class GetBtcHashInfoPayload : BaseGetHashInfoPayload
    {
    ...
    public class GetEthHashInfoPayload : BaseGetHashInfoPayload
    {
