...
{
    [TestClass]
    public class GetHistoricalTrades : BaseCollectionTest
    {
        protected override ICollectionResponse GetAllList()
        {
            return Manager.Exchanges.GetHistoricalTrades(Symbol);
        }

        protected override ICollectionResponse GetSkipList(int skip)
        {
            return Manager.Exchanges.GetHistoricalTrades(Symbol, skip: skip);
        }

        protected override ICollectionResponse GetLimitList(int limit)
        {
            return Manager.Exchanges.GetHistoricalTrades(Symbol, limit: limit);
        }

        protected override ICollectionResponse GetSkipAndLimitList(int skip, int limit)
        {
            return Manager.Exchanges.GetHistoricalTrades(Symbol, skip, limit);
        }
        ...
        {
            Manager.Exchanges.GetHistoricalTrades(symbol: null);
        }
        ...
        public void TestIncorrectSymbol()
        {
            ...
            var response = Manager.Exchanges.GetHistoricalTrades(symbol);
        ...
        public void TestIncorrectTimeInterval()
        {
            ...
            Manager.Exchanges.GetHistoricalTrades(Symbol, startPeriod, endPeriod);
        }
        ...
        public void TestIncorrectStartTimeFromPast()
        {
            ...
            var response = Manager.Exchanges.GetHistoricalTrades(Symbol, startPeriod, endPeriod);
        ...
        public void TestIncorrectStartTimeFromFeature()
        {
            ...
            Manager.Exchanges.GetHistoricalTrades(Symbol, startPeriod);
        }
