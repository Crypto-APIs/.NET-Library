...
namespace TestCryptoApiSdkProject.Exchanges
{
    ...
    public class HistoricalTrades : BaseCollectionTest
    {
        ...
        {
            return Manager.Exchanges.HistoricalTrades(Symbol);
        }

        protected override ICollectionResponse GetSkipList(int skip)
        {
            return Manager.Exchanges.HistoricalTrades(Symbol, skip: skip);
        }

        protected override ICollectionResponse GetLimitList(int limit)
        {
            return Manager.Exchanges.HistoricalTrades(Symbol, limit: limit);
        }

        protected override ICollectionResponse GetSkipAndLimitList(int skip, int limit)
        {
            return Manager.Exchanges.HistoricalTrades(Symbol, skip, limit);
        }
        ...
        {
            Manager.Exchanges.HistoricalTrades(symbol: null);
        }
        ...
        public void TestIncorrectSymbol()
        {
            ...
            var response = Manager.Exchanges.HistoricalTrades(symbol);
        ...
        public void TestIncorrectTimeInterval()
        {
            ...
            Manager.Exchanges.HistoricalTrades(Symbol, startPeriod, endPeriod);
        }
        ...
        public void TestIncorrectStartTimeFromPast()
        {
            ...
            var response = Manager.Exchanges.HistoricalTrades(Symbol, startPeriod, endPeriod);
        ...
        public void TestIncorrectStartTimeFromFeature()
        {
            ...
            Manager.Exchanges.HistoricalTrades(Symbol, startPeriod);
        }
