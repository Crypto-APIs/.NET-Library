...
namespace TestCryptoApiSdkProject.Exchanges
{
    ...
    [TestClass]
    public class GetHistoricalData : BaseTest
    {
        ...
        public void TestSimple()
        {
            ...
            var allSymbols = Manager.Exchanges.GetSymbols(0, 20000);
            for (var i = 0; i <= 10000; i++)
            {
                var id = allSymbols.Symbols[i].Id;
                var responseTemp = Manager.Exchanges.GetHistoricalData(new Symbol(id), period, startPeriod);
            ...
            var response = Manager.Exchanges.GetHistoricalData(symbol, period, startPeriod);
        ...
        public void TestLimit()
        {
            ...
            var response = Manager.Exchanges.GetHistoricalData(symbol, period, startPeriod, limit: 2);
        ...
        public void TestLimitOutOfRange()
        {
            ...
            var period = new Period("1day");
            var startPeriod = new DateTime(2019, 02, 04);
            Manager.Exchanges.GetHistoricalData(symbol, period, startPeriod, limit: 0);
        }
        ...
        public void TestStartFinish()
        {
            ...
            var response = Manager.Exchanges.GetHistoricalData(symbol, period, startPeriod, endPeriod);
        ...
        public void TestUndefinedSymbol()
        {
            var period = new Period("1day");
            var startPeriod = new DateTime(2019, 02, 04);
            Manager.Exchanges.GetHistoricalData(symbol: null, period: period, startPeriod: startPeriod);
        }
        ...
        public void TestUndefinedPeriod()
        {
            var symbol = new Symbol(SymbolId);
            var startPeriod = new DateTime(2019, 02, 04);
            Manager.Exchanges.GetHistoricalData(symbol, period: null, startPeriod: startPeriod);
        }
